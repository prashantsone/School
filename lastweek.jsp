<%-- 
    Document   : lastweek
    Created on : 17 Dec, 2024, 9:34:09 PM
    Author     : prash
--%>
...
<html>
    ...
    ResultSet rs = stmt.executeQuery("select STUD_ID, FULL_NAME ,To_char(DOB,'dd-mm-yyyy'),GENDER ,MOB_NO from stdinq WHERE INQ_DATE >SYSDATE-7 ");


    
     %>  
    <center>   
        <h1> Students Information According Last Week</h1>
