<%-- 
    Document   : allinq
    Created on : 17 Dec, 2024, 9:21:44 PM
    Author     : prash
--%>
...
<html>
    ...
    ResultSet rs = stmt.executeQuery("select STUD_ID, FULL_NAME ,To_char(DOB,'dd-mm-yyyy'),GENDER ,MOB_NO from stdinq ");
    ...
    <center>   
     ...
     %>            
         ...
         <tr>   <td><center><input  readonly value="<%=rs.getInt(1)%>"></td>
                ...
                <td><center><input  readonly value="<%=rs.getLong(5)%>"></center></td>     
