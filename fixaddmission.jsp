<%-- 
    Document   : goadminssion
    Created on : 13 Dec, 2024, 8:08:33 PM
    Author     : ADMIN
--%>
...
<html>
    ...
    <body>
        <%
            ...
            ResultSet rs=stmt.executeQuery("select STUD_ID,FULL_NAME,to_char(DOB,'dd-mm-yyyy'),GENDER,MOB_NO,CURR_ADD,PERM_ADD,NATIONALITY,CATEGORY,RELIGION,CASTE,PREV_STD,PER,SCH_NAME,SCH_ADD,NEW_STD,BRANCH,DIV,MEDIUM,USERNAME,PASSWORD,to_char(INQ_DATE,'dd-mm-yyyy') from stdinq  where stud_id= "+session.getAttribute("sid")+" ");
            if(rs.next())
            {
